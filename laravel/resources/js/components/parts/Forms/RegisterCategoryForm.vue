  ...
  <form :action="action" method="post" class="w-full max-w-lg p-3 bg-gray-50 absolute top-1/2 left-2/4">
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3 mb-6 md:mb-0">
        ...
        <input v-model="user_info['name']" id="name" name="name" type="text" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white">
