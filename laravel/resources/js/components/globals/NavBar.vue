    ...
    <div class="sticky top-0 z-10">
            <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
              ...
              <div class="flex items-center relative">
                ...
                <img src="../../../img/jellyfish.png" class="w-12 h-12 rounded-full shadow-lg" @click="dropDownOpen = !dropDownOpen">
              </div>
...
import DarkmodeButton from "../parts/Buttons/DarkmodeButton"
...
export default {
    ...
    created() {
      ...
      computed: {
    ...mapGetters({sideBarOpen: 'nav/sideBarOpen'})
  },
    methods: {
      toggleSidebar() {
        this.$store.dispatch('nav/getSideBarStatus', this.sideBarOpen)
      }
    }
}
</script>
